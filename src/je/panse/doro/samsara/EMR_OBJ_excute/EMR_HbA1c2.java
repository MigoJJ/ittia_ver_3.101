...
public class EMR_HbA1c2 extends JFrame implements ActionListener {
        ...
        if (source == clearButton) {
        	...
        	if (index < inputFields.length - 1) {
    	        ...
    	        if (!hba1cText.isEmpty()) {
    	            ...
    	            try {
    	                hba1cValue = Double.parseDouble(hba1cText);
    	                ...
    	                String outputText = String.format(
    	                    ...
    	                    "\teAG: %.0f mg/dL\n" +
    	                    "\teAG: %.1f mmol/l\n",
    	                    glucose_mgdl, hba1cValue, ifcc_hba1c_mmolmol, eag_mgdl, eag_mmoll);
    	                
    	                outputArea.setText(outputText);
    	                GDSEMR_frame.setTextAreaText(5, outputText);
    	                getGlucoseControlStatus(hba1cValue);
