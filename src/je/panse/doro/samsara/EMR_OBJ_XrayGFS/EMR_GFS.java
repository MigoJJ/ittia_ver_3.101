...
public class EMR_GFS {
	public static void main(String[] args) {
	    ...
	    String[] checklistItems = EMR_GFS.esophagusArray();
	    String[] checklistItems1 = EMR_GFS.stomachArray();
	    String[] checklistItems2 = EMR_GFS.colonArray();

	    // Create the labels and set their properties
	    JLabel[] labels = new JLabel[3];
	    labels[0] = new JLabel("Esophagus:");
	    labels[1] = new JLabel("Stomach and Duodenum:");
	    labels[2] = new JLabel("Colon:");
	    ...
	    checkboxes[2] = new JCheckBox[checklistItems2.length];
	    ...
	    for (JCheckBox[] checkboxeslist : new JCheckBox[][] {checkboxes[0], checkboxes[1], checkboxes[2]}) {
